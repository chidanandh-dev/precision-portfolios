...
const Calculator = createLucideIcon("calculator", __iconNode$x);
const __iconNode$w = [
...
const HeartHandshake = createLucideIcon("heart-handshake", __iconNode$h);
const __iconNode$g = [
...
const MessageSquareCheck = createLucideIcon("message-square-check", __iconNode$a);
const __iconNode$9 = [
  [
    "path",
    {
